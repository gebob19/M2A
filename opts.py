...
parser.add_argument('--model', type=str, default='tsm')
parser.add_argument('--n_batch_multiplier', type=int, default=1)
parser.add_argument("--local_rank", type=int,
                    help='local rank for DistributedDataParallel')
parser.add_argument('--i3d', default=False, action="store_true")
parser.add_argument('--compute_gflops', default=False, action="store_true")
...
# **** ------ ****
parser.add_argument('--temporal_module', type=str, default="tsm")

parser.add_argument('--dropout_type', type=str, default="normal",
                    choices=['normal', 'embed'])
parser.add_argument('--use_tsm', default=False, action="store_true")

parser.add_argument('--multi_node', default=False, action="store_true")
parser.add_argument('--init_method', default='tcp://127.0.0.1:3456', type=str, help='')
parser.add_argument('--dist-backend', default='gloo', type=str, help='')
parser.add_argument('--world_size', default=1, type=int, help='')
parser.add_argument('--distributed', action='store_true', help='')
parser.add_argument('--num_tasks_per_node', default=1, type=int, help='')
...
parser.add_argument('--trial_run', default=False, action="store_true")
