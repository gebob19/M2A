...
if __name__ == '__main__':
    ...
    for (filename_input, filename_output) in zip(files_input, files_output):
        ...
        for i in range(len(folders)):
            ...
            dir_files = os.listdir(os.path.join('../data/something/v2/20bn-something-something-v2-frames', curFolder))
            output.append('%s %d %d' % ('something/v2/20bn-something-something-v2-frames/'+curFolder, len(dir_files), curIDX))
