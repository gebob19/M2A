...
NUM_THREADS = 25
VIDEO_ROOT = '../../data/something/v2/20bn-something-something-v2/'         # Downloaded webm videos
FRAME_ROOT = '../../data/something/v2/20bn-something-something-v2-frames/'  # Directory for extracted frames
...
if __name__ == '__main__':
    ...
    splits = np.array_split(video_list, NUM_THREADS)
